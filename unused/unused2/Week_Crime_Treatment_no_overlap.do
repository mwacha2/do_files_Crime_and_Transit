...
replace `c'_week_after5 =  l5.`c'_week  if `c'_week ==0 & `c'_week_after1 ==0 & `c'_week_after2 ==0 & `c'_week_after3 ==0  & `c'_week_after4 ==0
replace `c'_week_after6 =  l6.`c'_week  if `c'_week ==0 & `c'_week_after1 ==0 & `c'_week_after2 ==0 & `c'_week_after3 ==0  & `c'_week_after4 ==0 & `c'_week_after5==0

****Before
global prior "`c'_week ==0 & `c'_week_after1 ==0 & `c'_week_after2 ==0 & `c'_week_after3 ==0  & `c'_week_after4 ==0 & `c'_week_after5==0  & `c'_week_after6==0"
...
if $prior & `c'_week_before1==0  & `c'_week_before2==0 & `c'_week_before3==0 & `c'_week_before4==0
replace `c'_week_before6 =  f6.`c'_week  ///
if $prior & `c'_week_before1==0  & `c'_week_before2==0 & `c'_week_before3==0 & `c'_week_before4==0 & `c'_week_before5==0
