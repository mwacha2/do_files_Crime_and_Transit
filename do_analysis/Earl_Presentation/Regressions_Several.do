...
global outputfile2   "${analysis}\Several\"
...
global fileoutnameJ "CControl_student_rev"
...
global fileoutnameK "CControl_student_rev"
...
global fileoutnameL "CControl_senior_rev"
...
global   weater_int " c.imput_avg_temp#i.xm_inc_tile c.imput_avg_temp#c.imput_avg_temp#i.xm_inc_tile c.prcp#i.xm_inc_tile"

/*
1.	Clean
2.	Temp controls 
3.	State by year 
4.	State by year and temp controls. 
5.	State by year and temp controls and crime control  
6.	State by 5 year time dum. 
7.	State by 5 year time dum. And temp controls. 
*/
...
global name1 "One" 
global model "Just Diff-in-Diff" 
 create_Treat
...
global name1 "Two" 
global model " Diff-in-Diff Year trend" 
 create_Treat
areg $dependent  $totalTreat i.stationFE i.stat_id#c.yeartrend  , absorb(weekFE)   $clusterlevel
outreg2 using "${outputfile2}\${fileoutname}.xml" , append slow(1000) keep($totalTreat) dec(4) ctitle("$model ") addtext( WeekFE, "X", StationFE, "X", Crime Control, "X")
sleep 2000
save_coeff 
graph_coeff
...
global name1 "Three" 
global model " Diff-in-Diff temp control " 
 create_Treat
areg $dependent  $totalTreat $weater_int i.stationFE  , absorb(weekFE)   $clusterlevel
outreg2 using "${outputfile2}\${fileoutname}.xml" , append slow(1000) keep($totalTreat) dec(4) ctitle("$model ") addtext( WeekFE, "X", StationFE, "X", Crime Control, "X")
sleep 2000
save_coeff 
graph_coeff
...
global name1 "Four" 
global model " Diff-in-Diff, temp control,year " 
 create_Treat
areg $dependent  $totalTreat $weater_int i.stationFE i.stat_id#c.yeartrend  , absorb(weekFE)   $clusterlevel
outreg2 using "${outputfile2}\${fileoutname}.xml" , append slow(1000) keep($totalTreat) dec(4) ctitle("$model ") addtext( WeekFE, "X", StationFE, "X", Crime Control, "X")
sleep 2000
save_coeff 
graph_coeff
...
global name1 "Five" 
global model " Diff-in-Diff, temp control,year crimeControl " 
 create_Treat
areg $dependent  $totalTreat $weater_int i.stationFE i.stat_id#c.yeartrend $controls  , absorb(weekFE)   $clusterlevel
outreg2 using "${outputfile2}\${fileoutname}.xml" , append slow(1000) keep($totalTreat) dec(4) ctitle("$model ") addtext( WeekFE, "X", StationFE, "X", Crime Control, "X")
sleep 2000
save_coeff 
graph_coeff
...
global name1 "Six" 
global model " Diff-in-Diff, Income Trend " 
 create_Treat
areg $dependent  $totalTreat $weater_int i.stationFE i.xm_inc_tile#c.yeartrend $controls  , absorb(weekFE)   $clusterlevel
outreg2 using "${outputfile2}\${fileoutname}.xml" , append slow(1000) keep($totalTreat) dec(4) ctitle("$model ") addtext( WeekFE, "X", StationFE, "X", Crime Control, "X")
sleep 2000
save_coeff 
graph_coeff
...
global name1 "Seven" 
global model " Diff-in-Diff, Time_Dum " 
 create_Treat
areg $dependent  $totalTreat $weater_int i.stationFE i.stat_id#i.time_dum $controls  , absorb(weekFE)   $clusterlevel
outreg2 using "${outputfile2}\${fileoutname}.xml" , append slow(1000) keep($totalTreat) dec(4) ctitle("$model ") addtext( WeekFE, "X", StationFE, "X", Crime Control, "X")
sleep 2000
save_coeff 
graph_coeff
...
graph combine  One Two Three Four Five Six Seven ,  name(combined, replace) note( "Dependent: $dependentTitle with  $CRIME_ENT", size(vsmall) )  title( "$title", size(small) )
