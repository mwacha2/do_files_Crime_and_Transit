...
*global interesting_vars " *violent_count *THEFT_count  *BURGLARY_count  *ARSON_count *ROBBERY_count  *BATTERYsimp_count *BATTERY_count *ASSAULTsimp_count  *ASSAULT_count  *CRIM_SEXUAL_ASSAULT_count  *violentSTD_count *violentNSEX_count *property_count *qual_life_count *crime_count"
global interesting_vars " *violent_count    *CRIM_SEXUAL_ASSAULT_count  *violentNSEX_count *property_count *qual_life_count *crime_count"


global name1 "Station"
global name2 "Outside"
global name3 "StatAll"

global condition1 " keep $keep_vars S_*count"
global condition2 "keep $keep_vars O_*count"
global condition3 "keep $keep_vars A_*_count"
...
export excel using "${analysis}\Charts\Count_By_Year${name`i'}.xls",firstrow(variables) replace
restore 
...
export excel using "${analysis}\Charts\Count_By_Day${name`i'}.xls",firstrow(variable) replace
restore 
...
export excel using "${analysis}\Charts\Count_By_Station${name`i'}.xls",firstrow(variables) replace
restore 
...
export excel using "${analysis}\Charts\Count_By_StationYear${name`i'}.xls",firstrow(variables) replace
restore 
...
export excel using "${analysis}\Charts\Count_By_Line${name`i'}.xls",firstrow(variables) replace
restore 
