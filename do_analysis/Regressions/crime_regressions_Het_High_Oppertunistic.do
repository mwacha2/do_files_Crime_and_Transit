...
global fileoutname "Prelim_Reg_High_Median.xml"
...
areg rides_numb $totalTreat i.year  , absorb(stationBYDOWFE)  robust
outreg2 using "${outputfile1}\${fileoutname}" , append slow(1000) keep($totalTreat) addtext( Year, "X", StationFEbyDAY, "X", Set , "`case'")
