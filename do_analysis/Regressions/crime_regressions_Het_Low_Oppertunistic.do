*restrict to weekends below medium 
*new
...
global fileoutname "Prelim_Reg_MedianWeekend.xml"
 ...
 *6 is saturday
 *0 sunday
 keep if inlist(day_of_week,5,6,0)
*collapse (first) day_of_week line_type year  month   (sum)O_* S_* ,by(stat_id datem) 
