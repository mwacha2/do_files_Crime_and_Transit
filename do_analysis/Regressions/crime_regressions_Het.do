...
foreach case in 0 1 2 3 4 5 6 7 8 {
...
areg rides_numb $totalTreat  i.dayofWeekFE i.stationFE i.year , absorb(stationBYmonthFE) robust
outreg2 using "${outputfile1}\${fileoutname}" , append slow(1000) keep($totalTreat) ctitle("STAT_MONTH") addtext( DayoftheWeekFE, "X", StationFE, "X" Year FE, "X", Station by Month FE , "X", Set , "`case'")
