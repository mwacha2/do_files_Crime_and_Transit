...
global totalTreat  "S_violent_week_L1"
global title "Station Crime and Ridership, Main"
*global weather "imput_avg_temp prcp " 
**

global fileoutname "MainResultsHomicide.xml"
global dependent "rides_numb_sum"
*global clusterlevel "vce( cluster stat_id )"
global clusterlevel "robust"
global totalTreat  "A_HOMICIDE_week_L1"
global title "Station Crime and Ridership, Main"
*global weather "imput_avg_temp prcp " 
**
...
global clusterlevel "vce( cluster stat_id )" 
*global clusterlevel "vce( robust )"
global totalTreat  "S_violent_week_L1 O_violent_week_L1 S_property_week_L1 O_property_week_L1 S_qual_life_week_L1 O_qual_life_week_L1"
