...
global outputfile1 "${analysis}\two_event\"
set matsize 2000
...
global totalTreata " SD_violent_wkOV SD_violent_wkOV_after1  SD_violent_wkOV_after2 "

global fileoutname "CoeffONE_SD_firearm_wkOV.xml"
global totalTreata " SD_firearm_wkOV SD_firearm_wkOV_after1  SD_firearm_wkOV_after2 "

global fileoutname "CoeffONE_D_HOMICIDE_week.xml"
global totalTreata " D_HOMICIDE_week D_HOMICIDE_week_after1 D_HOMICIDE_week_after2 "
...
foreach crime in  SD_violent_wkOV SD_firearm_wkOV D_HOMICIDE_week {
global crime `crime' 
global fileoutname "CoeffONE_${crime}.xml"
global totalTreata " ${crime} ${crime}_after1  ${crime}_after2 "


global title "Two Weeks Treatment,Crime"
