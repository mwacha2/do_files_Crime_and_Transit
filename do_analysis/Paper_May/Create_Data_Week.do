...
keep stat_id week A_firearm_week  A_property_week A_violent_week O_violent_week  O_violent_week A_qual_life_week  O_SimpleCrime_week S_SimpleCrime_week  S_property_week   S_qual_life_week  O_property_week   O_qual_life_week 

foreach var in  A_firearm_week  A_property_week A_violent_week  O_violent_week A_qual_life_week  O_SimpleCrime_week S_SimpleCrime_week  S_property_week   S_qual_life_week  O_property_week   O_qual_life_week  {
...
drop A_firearm_week* A_violent_week* A_property_week*  O_violent_week* A_qual_life_week*  O_SimpleCrime_week* S_SimpleCrime_week*  S_property_week*   S_qual_life_week*  O_property_week*   O_qual_life_week
...
egen crimeWeekFE = group(xm_basic_crime weekFE)
egen ratioWeekFE = group(xm_wk_ratio weekFE)
